export interface ManagerInvitationEmailTemplateInput {
  toName: string;
  setupUrl: string;
  invitedByName?: string;
}

export interface ManagerInvitationEmailContent {
  subject: string;
  htmlContent: string;
  textContent: string;
}
...
<html lang="fr">
  <head>
    ...
    <title>${managerInvitationEmailSubject}</title>
  </head>
...
export const createManagerInvitationEmailText = ({
  toName,
  setupUrl,
  invitedByName
}: ManagerInvitationEmailTemplateInput): string => {
...
export const createManagerInvitationEmail = (
  input: ManagerInvitationEmailTemplateInput
): ManagerInvitationEmailContent => ({
  subject: managerInvitationEmailSubject,
  htmlContent: createManagerInvitationEmailHtml(input),
  textContent: createManagerInvitationEmailText(input)
});
