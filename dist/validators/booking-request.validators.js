...
exports.updateBookingRequestPhotosValidators = exports.updateBookingRequestNotesValidators = exports.updateBookingRequestStatusValidators = exports.updateBookingRequestValidator = exports.getBookingRequestByIdValidators = exports.createManualBookingRequestValidators = exports.createBookingRequestValidators = exports.listBookingRequestsValidators = void 0;
...
const propertyDescriptionSafetyValidator = (value) => {
...
exports.createManualBookingRequestValidators = [
    (0, express_validator_1.body)("firstName")
        .trim()
        .notEmpty()
        .withMessage("First name is required")
    ...
    (0, express_validator_1.body)("marketingEmailConsent")
        ...
        .withMessage("Marketing email consent must be a boolean")
        .toBoolean(),
    (0, express_validator_1.body)("language").default("fr").isIn(["fr", "en"]).withMessage("Language must be fr or en"),
...
exports.updateBookingRequestValidator = [
    (0, express_validator_1.param)("id")
        .custom((value) => (0, mongoose_1.isValidObjectId)(value))
        .withMessage("Booking request ID must be a valid MongoDB ObjectId"),
    (0, express_validator_1.body)(protectedUpdateFields)
        .not()
        .exists()
